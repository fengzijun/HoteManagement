...
namespace HoteManagement.Data.Mapping
{
    ...
    public class occu_inforMap : BaseEntityTypeConfiguration<HoteManagement.Domain.occu_infor>
    {
       public occu_inforMap()
       {
          this.HasKey(t => t.Id);
          ...
          this.Property(t => t.occ_StyDate);
          this.Property(t => t.occ_headerImg).HasMaxLength(50);
          this.Property(t => t.occ_TfTime);
