...
namespace HoteManagement.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
    public class ContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new ArticleException("Unkown dependency");
            ...
            throw new ArticleException("No contructor was found that had all the dependencies satisfied.");
        }
